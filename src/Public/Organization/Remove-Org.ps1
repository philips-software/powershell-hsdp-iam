<#
    ...
    ⚠WARNING: This operation will do hard delete of the requested organization and all its associated resources like users, groups, roles etc.
    Upon successful process of this operation, all dependent resources of the organization will be permanently deleted from the system. 
    All identity access controls to any applications associated with deleting organization will be revoked. This operation will also revoke 
    any access to external organization resources from the identities belonging to the deleting organization.
